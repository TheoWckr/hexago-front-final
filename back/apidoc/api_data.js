define({ "api": [
  ...
  },
  {
    "type": "delete",
    "url": "/event/_id",
    "title": "delete an event by it id",
    "name": "DELETE_event_by_id",
    "group": "event",
    "description": "<p>Delete an event by it id</p>",
    "header": {
      "fields": {
        "Header": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "_id",
            "description": "<p>Unique ID of an event</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/event/searchid/_id",
    "title": "get an event by it id",
    "name": "GET_event_by_id",
    "group": "event",
    "description": "<p>Get an event by it id</p>",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  {
    "type": "get",
    "url": "/event/searchlist",
    "title": "search list of event",
    "name": "GET_event_searchlist",
    "group": "event",
    "description": "<p>search a list of events</p>",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "date",
            "description": "<p>start date to search for events, return all event within startdate until 7 days after</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "locationId",
            "description": "<p>the place of the event</p>"
          },
          {
            "group": "Parameter",
            "type": "ObjectId",
            "optional": false,
            "field": "listGames",
            "description": "<p>search a game within the array of games within the event</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": false,
            "field": "showEventFull",
            "description": "<p>return contains event which are full of player if set to true</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "date",
            "description": "<p>Date of an event (iso8601)</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "duration",
            "description": "<p>duration of the event in minutes</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "minPlayers",
            "description": "<p>minimum number of players to start an event</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "maxPlayers",
            "description": "<p>Maximum number of players for an event</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
            "optional": false,
            "field": "listGames",
            "description": "<p>list of games (gameDetails Object ID)</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
            "optional": false,
            "field": "listPlayers",
            "description": "<p>list of current players (users ObjectId)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "locationId",
            "description": "<p>location of the event informations</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "owner",
            "description": "<p>owner of the event</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "details",
            "description": "<p>details or description of the event</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "name": "PUT_event",
    "group": "event",
    "description": "<p>Modify an event</p>",
    "header": {
      "fields": {
        "Header": [
          {
            ...
            "optional": false,
            "field": "_id",
            "description": "<p>Unique ID of an event, make reference to id via the request param, NOT PART OF THE REQUEST BODY</p>"
          },
          {
            "group": "Header",
            "type": "String",
